  ...
  <table class="table table-striped">
    ...
    <tbody>
      <tr>
        ...
        <td>04/05/2021</td>
        <td>Push Inicial</td>
        <td>-Feito a página index com Hello World
        <br>-Adicionado JSPF para acessar bootstrap
         <br>-Colocado logotipo da empresa nas paginas 
         <br>-correção de titulo de página com favicon</td>
      </tr>
      ...
      <tr>
       <td>1.1</td>
        ...
        <br>-Configurado PostgreSQL direto na VM.
         <br>-Criado uma JSP que testa conexão com DB.   </td>  
 		</tr>
 		
 		<tr>
       <td>1.2</td>
        <td>06/05/2021</td>
        <td>Correção de servlets e feito jsp para teste de conexão com db</td>
        <td>-As servlets não estavam sendo encontradas no servidor. Corrigido.
        <br>-Melhorado a página de teste de conexão com DB, mostrando log de erro caso ocorra.    </td>
 		</tr>
       ...
       <td>1.3</td>
        ...
        <td>-Criado arquivo para testar banco de dados local, sem ter que ficar alterando o código nos testes.
        <br>-Feito conexão com o banco de dados local, e teste de escrita nas colunas. </td>
 		</tr>
       ...
       <td>1.4</td>
        ...
        <br>-É possível cadastrar um contêiner com todas as informações solicitadas no CRUD.
        <br>-Ao preencher formulário e clicar em cadastrar, caso sucesso uma mensagem é exibida.
        <br>-Ao preencher formulário e clicar em cadastrar, caso ocorra algum erro, o log de erro é exibido.
        </td>
 		</tr>
       ...
       <td>1.5</td>
        ...
        <td>-Adicionado página para listar conteiners.
        <br>-Modificado nome de arquivo das páginas.
        </td>
 		</tr>
